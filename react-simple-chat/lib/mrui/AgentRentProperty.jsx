        ...
        return (
             <GenericContainer 
               ...
               width="100%">
                ...
                <Content>
                <LineText> Agent Rent Property </LineText>
                <ContentItem>income: {p.incomeLabel}</ContentItem>
                <ContentItem>rentBudgetMax: {p.rentBudgetMaxLabel}</ContentItem>
                <ContentItem>numOfPeople: {p.numOfPeopleLivingLabel}</ContentItem>
                <ContentItem>isPetAllowed: {p.isPetAllowedLabel}</ContentItem>
                <ContentItem>level: {p.levelLabel}</ContentItem>
                <ContentItem>isViewAble: {p.isViewAbeleLabel}</ContentItem>
                <ContentItem>hasHomeHardware: {p.hasHomeHardwareLabel}</ContentItem>
                <ContentItem>leasingPeriod: {p.leasingPeriodLabel}</ContentItem>
                <ContentItem>jobNature: {p.jobNatureLabel}</ContentItem>
                <ContentItem>dayListed: {p.dayListed}</ContentItem>
