...
export default class AgentSaleProperty extends React.Component {
    constructor( props ) {
        super( props );
        ...
        return (
             <GenericContainer 
               ...
               width="100%">
                ...
                <Content>
                <LineText> Agent Sale Property </LineText>
                <ContentItem>: {p.partitionLabel}</ContentItem>
                <ContentItem>: {p.salePriceLabel}</ContentItem>
                <ContentItem>: {p.isPetAllowedLabel}</ContentItem>
                <ContentItem>: {p.isViewAbleLabel}</ContentItem>
                <ContentItem>: {p.levelLabel}</ContentItem>
                <ContentItem>: {p.roleName}</ContentItem>
                <ContentItem>: {p.howFresh}</ContentItem>
                <ContentItem>: {p.netSizeLabel}</ContentItem>
                <ContentItem>: {p.dayListed}</ContentItem>
                <ContentItem>: {p.isSaleWithLeaseLabel}</ContentItem>
                <ContentItem>: {p.dueDayLabel}</ContentItem>
