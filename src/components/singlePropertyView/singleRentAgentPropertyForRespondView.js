...
//        const { getFieldProps } = this.props.form;
 ...
 <Brief> 
  {property.jobNatureLabel}{property.incomeLabel}<br />{property.numOfPeopleLivingLabel}{property.rentBudgetMaxLabel}
 <br />
...
export const SingleRentAgentPropertyForRespondViewWrapper = createForm()(SingleRentAgentPropertyForRespondView);
