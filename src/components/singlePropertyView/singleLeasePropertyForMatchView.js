...
export default class SingleLeasePropertyForMatchView extends React.Component {
...
//    console.log( 'realTime will mount', this.props.property.realTime)
  ...
  <Card full>
   <Badge text={'平'} corner>
    ...
    <Card.Body>
        <div>{property.leasePriceLabel}{property.partitionLabel}{property.isFreeForSevenDayLabel}{property.earlyTimeToViewLabel}{property.hasHomeHardwareLabel}
        </div>
    </Card.Body>
