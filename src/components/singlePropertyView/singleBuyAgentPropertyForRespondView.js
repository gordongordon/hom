...
//        const { getFieldProps } = this.props.form;
 ...
 <Brief> 
 {property.partitionLabel}<br />{property.earlyTimeToViewLabel}
 <br />
...
export const SingleBuyAgentPropertyForRespondViewWrapper = createForm()(SingleBuyAgentPropertyForRespondView);
