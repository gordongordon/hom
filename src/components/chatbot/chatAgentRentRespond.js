...
import SlickAgentRentProperty from './slickAgentRentProperty';
...
class ChatAgentRentRespond extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      clicked: "none",
...
//                component: <Slick keyID={keyID}/>,
                component: <SlickAgentRentProperty keyID={keyID}/>,
                //component: <RCarouse />,
...
export default ChatAgentRentRespond;
