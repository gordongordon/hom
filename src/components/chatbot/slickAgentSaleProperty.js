...
import {AgentSaleProperty as ItemView } from "react-simple-chatbot";


const prompt = Modal.prompt;

@observer
export default class SlickAgentSaleProperty extends React.Component {
  constructor( props ) {
    super( props )
    this.state = {
      data: ['', '', ''],
...
SlickAgentSaleProperty.propTypes = {
  steps: PropTypes.object,
  triggerNextStep: PropTypes.func,
};

SlickAgentSaleProperty.defaultProps = {
  steps: undefined,
