...
import SlickAgentBuyProperty from './slickAgentBuyProperty';
...
class ChatAgentBuyRespond extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      clicked: "none",
...
//                component: <Slick keyID={keyID}/>,
                component: <SlickAgentBuyProperty keyID={keyID}/>,
                //component: <RCarouse />,
...
export default ChatAgentBuyRespond;
