...
@observer
export class SingleMatchPropertyView extends React.Component{

    render(){
        //const model = this.props.model
        const {property, keyId , propertys } = this.props;

        //console.log( ' Single Match Property View')

        //console.log(property.matchedPropertys);
        //property.getMatchProperty( 123, 'location', 'shatin');
        //const key = this.props.key
        //console.log( 'key ', key )

        return <div> <h4>------- Matched Property ---------</h4>
                <p>
